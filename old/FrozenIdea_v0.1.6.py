#!/usr/bin/env python
# -*- coding: utf-8 -*- 
#~ FrozenIdea v0.1.6 (09.06.08) by bystrousak@seznam.cz.
...
def Logic((sender, type, msg)):    
    ...
    if type.startswith("KICK"): # if someone kick bot owner
        tmp= type.split(" ")
        if tmp[2]==Bot.owner:
            Bot.owner= ""
            
    if type.startswith("QUIT") and sender==Bot.owner: # if someone use bot nick
        Bot.owner= ""
